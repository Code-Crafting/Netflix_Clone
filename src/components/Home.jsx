  ...
  return (
    <div>
      ...
      <div className="-mt-32 flex flex-col gap-16">
        <CardsCon category="Popular Movies" dataCategory="now_playing" />
        <CardsCon category="Blockbuster Movies" dataCategory="top_rated" />
        <CardsCon category="Only on Netflix" dataCategory="popular" />
        <CardsCon category="Upcoming" dataCategory="upcoming" />
      </div>
    </div>
  );
}
